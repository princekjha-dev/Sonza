...
/**
 * Parser for TTML (Timed Text Markup Language) format used by Apple Music.
 * Converts TTML XML to standard LRC format with optional word-level timing.
 */
object TTMLParser {
    ...
    fun toLRC(lines: List<ParsedLine>): String {
        return buildString {
            lines.forEach { line ->
                ...
                // Optional: Include word-level timing metadata (custom format)
