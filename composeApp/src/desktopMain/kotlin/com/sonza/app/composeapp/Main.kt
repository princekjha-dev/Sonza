...
import com.sonza.app.composeapp.newpipe.YouTubeSearch
...
private const val APP_VERSION = "2.5.4.0"
...
private suspend fun resolveStreamSong(result: RemoteSearchResult): Song? {
    val nativeResult = com.sonza.app.composeapp.newpipe.SearchResult(
        title = result.title,
        uploader = result.uploader,
        durationSeconds = result.durationSeconds,
        url = result.url,
