...
class CrashReportSender : ReportSender {
    ...
    companion object {
        private const val TELEGRAM_USERNAME = "princekjha-dev"
    ...
    private fun writeCrashReportFile(
        ...
        val file = File(dir, "sonza_crash_$timestamp.txt")

        file.bufferedWriter().use { writer ->
            writer.appendLine("═══════════════════════════════════════")
            writer.appendLine("  Sonza Crash Report")
    ...
    private fun buildShareIntent(fileUri: Uri): Intent {
        ...
        return Intent(Intent.ACTION_SEND).apply {
            ...
            putExtra(Intent.EXTRA_SUBJECT, "Sonza Crash Report")
