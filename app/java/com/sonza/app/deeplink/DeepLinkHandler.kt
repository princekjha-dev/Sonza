package com.sonza.app.deeplink

import android.net.Uri

/**
 * Parses incoming deep links of the form:
 *   sonza://play?id={videoId}             (legacy)
 *   sonza://song/{videoId}
 *   sonza://album/{browseId}
 *   sonza://playlist/{playlistId}
 *   sonza://artist/{channelId}
 *   sonza://search?q={query}
 *
 * Returns null when the URI does not match any known target.
 */
object DeepLinkHandler {

    const val SCHEME = "sonza"
