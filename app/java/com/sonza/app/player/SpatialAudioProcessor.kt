...
class SpatialAudioProcessor @Inject constructor(
    ...
    fun applyAIState(state: com.sonza.app.ai.AudioEffectState) {
    ...
    fun getCurrentState(): com.sonza.app.ai.AudioEffectState {
        return com.sonza.app.ai.AudioEffectState(
    ...
    fun getSignalStats(): com.sonza.app.ai.SignalStats {
        return com.sonza.app.ai.SignalStats(
