...
import com.sonza.app.ui.theme.NewReleaseCardShape
                    ...
                    when (item) {
                        ...
                        is HomeItem.PlaylistItem -> {
                             ...
                             val tempSong = remember(item.playlist) {
                                 Song(item.playlist.id, item.playlist.name, item.playlist.uploaderName, "Playlist", 0L, item.playlist.thumbnailUrl, com.sonza.app.core.model.SongSource.YOUTUBE)
                             }
                         ...
                         is HomeItem.AlbumItem -> {
                             val tempSong = remember(item.album) {
                                 Song(item.album.id, item.album.title, item.album.artist, "Album", 0L, item.album.thumbnailUrl, com.sonza.app.core.model.SongSource.YOUTUBE)
                             }
...
fun GridSection(
    ...
    val isLandscape = com.sonza.app.ui.utils.isLandscape()
