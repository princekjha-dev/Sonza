...
import com.sonza.app.ai.AIProvider
import com.sonza.app.ui.components.BetaBadge
import com.sonza.app.ui.screens.ai_equalizer.AIEqLogsPanel
import com.sonza.app.ui.screens.ai_equalizer.AIEqPromptHistoryDialog
import com.sonza.app.ui.screens.ai_equalizer.AIEqPromptInput
import com.sonza.app.ui.screens.ai_equalizer.AIEqResultActions
...
@Composable
fun AIResultCard(state: com.sonza.app.ai.AudioEffectState) {
    Card(
        modifier = Modifier.fillMaxWidth(),
        shape = RoundedCornerShape(20.dp),
        colors = CardDefaults.cardColors(
...
fun PromptHistoryItem(
    entry: com.sonza.app.ai.PromptHistoryEntry,
    onClick: () -> Unit,
    onDelete: () -> Unit
) {
