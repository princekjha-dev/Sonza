...
object LyricsPdfGenerator {
    ...
    suspend fun generateAndSharePdf(
        ...
        try {
            ...
            // Branding Colors (Matching Sonza Theme)
            ...
            while (currentLine < totalLines) {
                ...
                canvas.drawText("Sonza", pageWidth - 50f, 60f, brandingPaint)
                ...
                canvas.drawText("Exported from Sonza", pageWidth / 2f, pageHeight - 15f, footerPaint.apply { textSize = 8f })
    ...
    private fun savePdfToDocuments(context: Context, document: PdfDocument, title: String): android.net.Uri? {
        ...
        val contentValues = android.content.ContentValues().apply {
            ...
            put(android.provider.MediaStore.MediaColumns.RELATIVE_PATH, android.os.Environment.DIRECTORY_DOCUMENTS + "/Sonza")
        }
