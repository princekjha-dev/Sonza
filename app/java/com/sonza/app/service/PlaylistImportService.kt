...
class PlaylistImportService : Service() {
    ...
    @Inject
    lateinit var spotifyImportHelper: com.sonza.app.util.SpotifyImportHelper

    @Inject
    lateinit var youTubeRepository: YouTubeRepository

    @Inject
    lateinit var libraryRepository: com.sonza.app.core.domain.repository.LibraryRepository
    ...
    companion object {
        ...
        const val ACTION_START = "com.sonza.app.action.START_IMPORT"
