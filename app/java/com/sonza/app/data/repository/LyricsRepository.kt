...
import com.sonza.app.providers.lyrics.LyricsLine
import com.sonza.app.core.model.Song
import com.sonza.app.core.model.SongSource
import com.sonza.app.providers.lyrics.BetterLyricsProvider
import com.sonza.app.providers.lyrics.LyricsProvider
import com.sonza.app.simpmusic.SimpMusicLyricsProvider
import com.sonza.app.kugou.KuGouLyricsProvider
import com.sonza.app.lrclib.LrcLibLyricsProvider
...
import com.sonza.app.util.LyricsUtils
...
class LyricsRepository @Inject constructor(
    ...
    private val localLyricsProvider: com.sonza.app.providers.lyrics.LocalLyricsProvider,
    ...
    private val circuitBreaker = com.sonza.app.providers.lyrics.ProviderCircuitBreaker()
    ...
    private fun parseLrcLyrics(lrcContent: String): List<LyricsLine> {
        return com.sonza.app.util.LyricsUtils.parseLyrics(lrcContent)
    }
