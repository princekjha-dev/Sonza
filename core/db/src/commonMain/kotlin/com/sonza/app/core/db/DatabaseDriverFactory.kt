...
/**
 * Convenience: build a fully-configured [SonzaDatabase] from a factory.
 * Lives in commonMain so both Android and Desktop call sites use the
 * same wiring.
 */
fun buildDatabase(factory: DatabaseDriverFactory): SonzaDatabase =
    SonzaDatabase(factory.createDriver())
